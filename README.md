...
---
**Source Code**: <a href="https://github.com/enodllew/scapi"
target="_blank">https://github.com/enodllew/scapi</a>
...
```shell
curl -LOs https://github.com/enodllew/scapi/releases/download/0.2.4/scapi.py
```
or
```shell
wget https://github.com/enodllew/scapi/releases/download/0.2.4/scapi.py
```
...
License](https://github.com/enodllew/scapi/blob/main/LICENSE)
